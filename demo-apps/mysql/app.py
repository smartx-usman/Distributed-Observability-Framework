...
#sysbench   --threads=4   --rate=300   --time=3600   --percentile=99   --report-interval=5   --db-driver=mysql --mysql-host=mysql.uc1.svc.cluster.local --mysql-port=3306 --mysql-db=sbtest --mysql-user=sbtest_user --mysql_password=password --tables=16 --table-size=10000 /usr/share/sysbench/oltp_read_write.lua prepare
#sysbench   --threads=4   --rate=300   --time=60   --percentile=99   --report-interval=5   --db-driver=mysql --mysql-host=mysql.uc1.svc.cluster.local --mysql-port=3306 --mysql-db=sbtest --mysql-user=sbtest_user --mysql_password=password --tables=16 --table-size=10000 /usr/share/sysbench/oltp_read_write.lua run
